        ...
        if is_batchnorm:
            for i in range(1, n + 1):
                conv = nn.Sequential(nn.Conv3d(in_size, out_size, ks, s, p),
                                     nn.InstanceNorm3d(out_size), nn.ReLU(inplace=True),)
...
class UNet3Plus(nn.Module):
    def __init__(self, n_channels=3, n_classes=1, bilinear=True, feature_scale=4,
        ...
        self.h1_PT_hd4_bn = nn.InstanceNorm3d(self.CatChannels)
        ...
        self.h2_PT_hd4_bn = nn.InstanceNorm3d(self.CatChannels)
        ...
        self.h3_PT_hd4_bn = nn.InstanceNorm3d(self.CatChannels)
        self.h3_PT_hd4_relu = nn.ReLU(inplace=True)

        # h4->40*40, hd4->40*40, Concatenation
        self.h4_Cat_hd4_conv = nn.Conv3d(filters[3], self.CatChannels, 3, padding=1)
        self.h4_Cat_hd4_bn = nn.InstanceNorm3d(self.CatChannels)
        ...
        self.hd5_UT_hd4_bn = nn.InstanceNorm3d(self.CatChannels)
        self.hd5_UT_hd4_relu = nn.ReLU(inplace=True)

        # fusion(h1_PT_hd4, h2_PT_hd4, h3_PT_hd4, h4_Cat_hd4, hd5_UT_hd4)
        self.conv4d_1 = nn.Conv3d(self.UpChannels, self.UpChannels, 3, padding=1)  # 16
        self.bn4d_1 = nn.InstanceNorm3d(self.UpChannels)
        ...
        self.h1_PT_hd3_bn = nn.InstanceNorm3d(self.CatChannels)
        ...
        self.h2_PT_hd3_bn = nn.InstanceNorm3d(self.CatChannels)
        self.h2_PT_hd3_relu = nn.ReLU(inplace=True)

        # h3->80*80, hd3->80*80, Concatenation
        self.h3_Cat_hd3_conv = nn.Conv3d(filters[2], self.CatChannels, 3, padding=1)
        self.h3_Cat_hd3_bn = nn.InstanceNorm3d(self.CatChannels)
        ...
        self.hd4_UT_hd3_bn = nn.InstanceNorm3d(self.CatChannels)
        ...
        self.hd5_UT_hd3_bn = nn.InstanceNorm3d(self.CatChannels)
        self.hd5_UT_hd3_relu = nn.ReLU(inplace=True)

        # fusion(h1_PT_hd3, h2_PT_hd3, h3_Cat_hd3, hd4_UT_hd3, hd5_UT_hd3)
        self.conv3d_1 = nn.Conv3d(self.UpChannels, self.UpChannels, 3, padding=1)  # 16
        self.bn3d_1 = nn.InstanceNorm3d(self.UpChannels)
        ...
        self.h1_PT_hd2_bn = nn.InstanceNorm3d(self.CatChannels)
        self.h1_PT_hd2_relu = nn.ReLU(inplace=True)

        # h2->160*160, hd2->160*160, Concatenation
        self.h2_Cat_hd2_conv = nn.Conv3d(filters[1], self.CatChannels, 3, padding=1)
        self.h2_Cat_hd2_bn = nn.InstanceNorm3d(self.CatChannels)
        ...
        self.hd3_UT_hd2_bn = nn.InstanceNorm3d(self.CatChannels)
        ...
        self.hd4_UT_hd2_bn = nn.InstanceNorm3d(self.CatChannels)
        ...
        self.hd2_UT_hd1_bn = nn.InstanceNorm3d(self.CatChannels)
        ...
        self.hd3_UT_hd1_bn = nn.InstanceNorm3d(self.CatChannels)
        ...
        self.hd4_UT_hd1_bn = nn.InstanceNorm3d(self.CatChannels)
        ...
        self.hd5_UT_hd1_bn = nn.InstanceNorm3d(self.CatChannels)
        self.hd5_UT_hd1_relu = nn.ReLU(inplace=True)

        # fusion(h1_Cat_hd1, hd2_UT_hd1, hd3_UT_hd1, hd4_UT_hd1, hd5_UT_hd1)
        self.conv1d_1 = nn.Conv3d(self.UpChannels, self.UpChannels, 3, padding=1)  # 16
        self.bn1d_1 = nn.InstanceNorm3d(self.UpChannels)
...
def main():
    shape = (96, 96, 128)
    input = torch.randn((1, 1, *shape))  # Example input for 3D data
    model = UNet3Plus(n_channels=1, n_classes=1, filters=[16, 32, 64, 128, 256])
    # print(model)
    out = model(input)
    print(out.shape)
    from torchinfo import summary

    summary(model, input_size=(1,1,*shape)) # 803,570
